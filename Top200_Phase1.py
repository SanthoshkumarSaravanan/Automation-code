# -*- coding: utf-8 -*-
"""
Created on Tue Sep 21 21:08:55 2021
...
#sams_crawl["ebags_unique_identifier"]
...
try:
    del bj_out["Unnamed: 14"] 
except:
    pass
             
try:
    del bj_out["Unnamed: 13"]     
except:
    pass
...
#sams_out["Sams Club Price"].head(75)
...
#Status
status.insert(loc = 2, column = 'date', value = "")
...
status.iloc[ : , 2 ]=np.where((status.iloc[ : , 2 ]=="na"),"Offline",status.iloc[ : , 2 ])
#########################################################################################################
#ECOM Changes
...
cvr.insert(loc = 3, column = 'Price_Difference', value = "")
